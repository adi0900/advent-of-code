...
def main(args):
    # Read inputs from the file 'Day20/input.txt'
    grid = parse_input('Day24/input.txt')
    
    # Assuming 'grid' is a list of lines, as 'parse' would return values and operations
...
def parse_input(filename):
    ...
    with open(filename) as inf:
        lines = inf.readlines()
    return [line.strip() for line in lines]  # return cleaned lines
